...
DATABASE_NAME = 'gamecard'             # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/zzdata/gamecard/static/'
if DEBUG:
    MEDIA_ROOT = '/data/gamecard/static/'
...
MIDDLEWARE_CLASSES = (
    ...
    'gamecard.middlewares.AuthMiddleware',
)
